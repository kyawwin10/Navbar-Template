...
import {
  ...
  increasementQty,
  removeFromFavourite,
} from "@/store/feature/favouriteSlice";
          ...
          {cart.length === 0 ? (
            ...
            <>
              ...
              <div className="flex justify-between">
                <span className="font-semibold text-[#731212]">Subtotal</span>
                <span className="font-semibold text-[#731212]">{subTotal}</span>
              </div>
                ...
                >
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Button
                      ...
                      variant="destructive"
                      onClick={() =>
                        dispatch(removeFromFavourite(item.productId))
                      }
                    >
                      Remove
                    </Button>
